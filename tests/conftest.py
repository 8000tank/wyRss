...
def mock_env_vars(tmp_path: Path) -> dict[str, str]:
    ...
    return {
        ...
        "RSS_LLM_API_KEY": "test-llm-api-key",
        "RSS_LLM_BASE_URL": "https://api.example.com/v1",
        "RSS_LLM_MODEL": "test-model",
